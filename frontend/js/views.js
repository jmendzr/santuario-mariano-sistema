          ...
          <div class="card-body">
            ${docsGen.length ? docsGen.map(d=>`<div class="doc-item">
              ...
              <div class="doc-actions">
                <a href="${API.urlDocumento(d.nombre_archivo)}" target="_blank" class="btn btn-outline btn-sm">⬇ Ver/Descargar</a>
  ...
  async function openSacModal(feligresId, sacKey, sacId) {
    ...
    const docsHtml = docs.map(d=>`
      <div class="doc-item" style="margin-bottom:8px">
        ...
        <div class="doc-actions">
          <a href="${API.urlDocumento(d.nombre_archivo)}" target="_blank" class="btn btn-outline btn-xs">⬇ Ver</a>
      ...
      </div>`).join('') || '<div class="text-muted" style="font-size:12px">Sin documentos adjuntos</div>';
