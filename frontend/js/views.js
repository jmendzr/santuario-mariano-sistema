  ...
  async function openSacModal(feligresId, sacKey, sacId) {
    ...
    const docsHtml = docs.map(d=>`
      <div class="doc-item" style="margin-bottom:8px">
        ...
        <div class="doc-actions">
          <a href="${d.ruta_almacen && d.ruta_almacen.startsWith('http') ? d.ruta_almacen : API.urlDocumento(d.nombre_archivo)}" target="_blank" class="btn btn-outline btn-xs">👁 Ver</a>
